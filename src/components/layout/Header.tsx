        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <div className="hidden sm:flex flex-col text-left">
              ...
              <span className="text-[10px] font-medium text-slate-400 leading-tight uppercase">
            ...
            <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-xl p-2 z-50 animate-in fade-in zoom-in-95 duration-100">
              <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-800 mb-1">
                ...
                <div className="mt-1.5 flex items-center gap-1.5">
                  <span className="px-2 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 text-[10px] font-semibold border border-emerald-200/60 dark:border-emerald-800 flex items-center gap-1">
                    <ShieldCheck className="w-3 h-3" />
                    Role: <strong className="uppercase">{currentUser?.role?.replace('_', ' ')}</strong>
                  </span>
                  {currentUser?.isLocked && (
                    <span className="px-2 py-0.5 rounded-full bg-amber-50 dark:bg-amber-950 text-amber-700 dark:text-amber-300 text-[10px] font-semibold border border-amber-200 dark:border-amber-800 flex items-center gap-1">
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs text-brand-600 dark:text-brand-400 hover:bg-brand-50 dark:hover:bg-brand-950/50 transition-colors font-semibold"
              >
              ...
              <div className="pt-1 mt-1 border-t border-slate-100 dark:border-slate-800">
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/50 transition-colors font-semibold text-left"
                >
